...
import { clearIsTrainCreated, clearTrainError } from '../../../slices/trainSlice';
import { createNewTrain } from '../../../actions/trainAction';
...
const CreateTrain = ({ setBgImage }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            dispatch(createNewTrain(formData));
        }
    })
    ...
    return (
        <>
            <MetaData title={"Create new train"} />
            {
                loading ? <Loader /> : (
                    ...
                    <main className='flex'>
                        ...
                        <div id="main" className="w-full lg:w-5/6 md:p-8 bg-gray-100 h-screen overflow-y-auto">
                            <div className=" w-full bg-blue-950 p-3 text-center mb-3 text-white px-6">
                                <h2 className="text-xl font-bold ">Register New Train</h2>
                            </div>
                            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md ">
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <select id="trainType"
                                                ...
                                                <option value="MemuExpress">MemuExpress</option>
                                            </select>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                        <div>
                                            <label for="classNameName" className="block text-gray-700 font-semibold">class name</label>
                                        ...
                                        <div>
                                            <label for="fare" className="block text-gray-700 font-semibold">class Fare</label>
                                        ...
                                        <div>
                                            <label for="totSeat" className="block text-gray-700 font-semibold">Total Seats</label>
                                        ...
                                        <div>
                                            <label for="amenities" className="block text-gray-700 font-semibold">Amenities</label>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                        <div className="relative">
                                            <label for="stations" className="block text-gray-700 font-semibold">Search station</label>
                                        ...
                                        <div>
                                            <label for="distance" className="block text-gray-700 font-semibold">Distance from source
                                                station</label>
                                        ...
                                        <div>
                                            <label for="arrival" className="block text-gray-700 font-semibold">Arrival time</label>
                                        ...
                                        <div>
                                            <label for="departure_time" className="block text-gray-700 font-semibold">Departure
                                                time</label>
                                        ...
                                        <div>
                                            <label for="halt_time" className="block text-gray-700 font-semibold">Halt time</label>
                                        ...
                                        <div>
                                            <label for="route_number" className="block text-gray-700 font-semibold">Route Number</label>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                        <div className="relative">
                                            <label for="returnstations" className="block text-gray-700 font-semibold">Search station</label>
                                        ...
                                        <div>
                                            <label for="returndistance" className="block text-gray-700 font-semibold">Distance from source
                                                station</label>
                                        ...
                                        <div>
                                            <label for="returnarrival" className="block text-gray-700 font-semibold">Arrival time</label>
                                        ...
                                        <div>
                                            <label for="returndeparture_time" className="block text-gray-700 font-semibold">Departure
                                                time</label>
                                        ...
                                        <div>
                                            <label for="returnhalt_time" className="block text-gray-700 font-semibold">Halt time</label>
                                        ...
                                        <div>
                                            <label for="returnRoutenumber" className="block text-gray-700 font-semibold">Route Number</label>
